...
namespace Class_Object_Bank_Transfer
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(cnt<2)
            {
                bank[cnt].Number = Convert.ToInt32(textBox1.Text);
                bank[cnt].Name = textBox2.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                sb.Append("\nAccount Number: " + bank[cnt].Number);
                sb.Append("\nAccount Name: " + bank[cnt].Name);
